...
export default {
  ...
  methods: {
    ...
    tableLinkHandler(data) {
      ...
      HttpService.get('priviapi/enterprise/searchJoinEnterprise', data, function (data) {
    ...
    topNavSearchHandler(data) {
      ...
      // var hrefStr = './joinEnterpriseSearchResult.html?word=' + data;
      // window.location.href = hrefStr;
      this.$router.push('/joinEnterpriseSearchResult?word=' + data)
    },
    //表单发出的模糊搜索请求
    ...
    tableLinkClickHandler(data) {
      ...
      var param = { enterpriseId: data.enterpriseId, id: data.userId, iscreate: false };
      ...
      //              this.approlDetailData.data=[{date:'2017年12月27日',time:'13:20:04',content:'提交审核'},{date:'2017年12月27日',time:'13:20:04',content:'提交审核'},{date:'2017年12月27日',time:'13:20:04',content:'提交审核'}];
    },
    //左侧菜单点击事件
    ...
    tableBtnClickHandler(data) {
      ...
      if (data.tableBtnType == "remove") {
        ...
        // var hrefStr = './joinInformationModification.html?id=' + data.userId + '&enterpriseId=' + data.enterpriseId;
        // window.location.href = hrefStr;
        that.$router.push('/joinInformationModification?id=' + data.userId + '&enterpriseId=' + data.enterpriseId)
      }
    },
