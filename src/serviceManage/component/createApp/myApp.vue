...
export default{
  ...
  data () {
    return {
      breadcrumb: [{name: '应用管理', link: ''}, {name: '我的应用', link: ''}],
      searchKey: {}, // 查询关键字
      selectSetting: [], // 筛选项
  ...
  methods: {
    ...
    setSelectData: function () {
      ...
      item2.data = appCommonFunc.getAuditStatusDic()
    ...
    onQuery: function () {
      ...
      apiClient.post('/itsmApi/application/queryPersonalAppList', params, function (data) {
