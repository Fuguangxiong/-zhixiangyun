...
var JSONFormat = (function(){
    ...
    function _format_array(object, indent_count){
        ...
        return '<span data-type="array" data-size="' + tmp_array.length + '"><i  style="cursor:pointer;" class="fa fa-minus-square-o hideTag" ></i>[<br/>'
            + tmp_array.join(',<br/>')
    ...
    function _format_object(object, indent_count){
        ...
        return '<span  data-type="object"><i  style="cursor:pointer;" class="fa fa-minus-square-o hideTag" ></i>{<br/>'
            + tmp_array.join(',<br/>')
            + '<br/>' + indent_tab(indent_count - 1) + '}</span>';
    }
...
var hide = function(obj){
    ...
    $(obj).parent().attr('data-inner',$(obj).parent().html());
    if (data_type === 'array') {
    	$(obj).parent().html('<i  style="cursor:pointer;" class="fa fa-plus-square-o showTag" ></i>Array[<span class="json_number">' + data_size + '</span>]');
    }else{
    	$(obj).parent().html('<i  style="cursor:pointer;" class="fa fa-plus-square-o showTag" ></i>Object{...}');
    }

}

var show = function(obj){
    var innerHtml = $(obj).parent().attr('data-inner');
    $(obj).parent().html(innerHtml);
}
