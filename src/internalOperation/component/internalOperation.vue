    ...
    <div class="publicRightContainer">
      <div class="publicWidthHeightContainer">
        <div class="publicRightTopContainer">
          <public-header :hide-menu='hideMenu' :nav-data="topNavData" :userchange="publicTopUserChange" :modular-name="modularName" :has-msg="hasMsg" :special="mySpecial" v-on:linkchange="linkChangeHandler" v-on:special="specialLinkChange"></public-header>
        </div>
        <div class="publicRightBottomContainer padding20">
          <div class="publicRightBottomContentContainer" :class="{welcome:welactive}">
            <!--添加Dom的地方-->
            <router-view>
...
export default {
  ...
  data () {
    return {
      ...
      leftNavData: [
        ...
        {name: '企业审核', link: 'enterpriseApproveList', imageClass: 'companyaudi', active: false, code: '019'},
        {name: '个人认证', link: 'personalAuthenticationList', imageClass: 'personal', active: false, code: '020'},
        {name: '资源管理',
          link: '',
        ...
        {name: '服务管理',
          ...
          children: [
            ...
            // {name: '企业服务', link: 'enterprise', active: false},
        ...
        {name: '黑白名单管理',
          link: '',
          imageClass: 'powermanage',
          active: false,
          code: '018',
          children: [
            {name: '黑名单管理', link: 'blackList', active: false, code: '018001'},
            {name: '白名单管理', link: 'whiteList', active: false, code: '018002'},
            {name: '评价黑名单', link: 'evaluationBlackList', active: false, code: '018003'}
          ]
        },
        {name: '公告管理', link: 'notice', imageClass: 'notice', active: false, code: '021'},
        {name: '评价管理', link: 'evaluation', imageClass: 'evaluation', active: false, code: '010'},
        {name: '应用市场管理', link: 'appTemplateConfig', imageClass: 'appmarketmanage', active: false, code: '016'},
        {name: '应用管理',
          link: '',
          ...
          code: '012',
          children: [
            {name: '平台应用', link: 'enterpriseApp', active: false, code: '012001'},
            {name: '我的应用', link: 'myApp', active: false, code: '012002'},
            {name: '第三方应用', link: 'thirdPartyApp', active: false, code: '012003'},
            {name: '端口管理', link: 'portManager', active: false, code: '012004'}
          ]
        },
        {name: '开发者平台', link: 'categoryManage', imageClass: 'appmanager', active: false, code: '017'}
      //  {name: '运营管理', link: '', imageClass: 'operationmanage', active: false},
      //  {name: '消息管理', link: '', imageClass: 'newsmanage', active: false},
      ...
      imageClassMap: {
        ...
        '个人认证': 'personal',
        '企业审核': 'companyaudi',
        '应用市场管理': 'appmarketmanage'
      },
      modularName: {name: '内部运营', link: 'internalOperation'},
      hasMsg: true,
      welactive: true,
  ...
  created () {
    ...
    this.$route.name == 'internalOperation' ? this.welactive = true : this.welactive = false
    var that = this
