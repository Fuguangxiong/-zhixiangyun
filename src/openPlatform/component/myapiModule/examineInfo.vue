      ...
      <div class="inpfrom">
        ...
        <div class="divtime">
            ...
            <div class="con-cont wid">
                <div class="logoImg">
                    <img v-show="bg_img_status == 1" src="../../images/img/logo-sm-default.jpg" alt="">
                ...
                <div class="bgImg">
                    <img v-show="logo_img_status == 1" src="../../images/img/logo-sm-default.jpg" alt="">
...
<style src="../../css/myapiCSS/examineinfo.css" scoped></style>
